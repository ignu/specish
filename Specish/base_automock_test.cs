using System;
using AutoMockContainer=Moq.AutoMockContainer;
using IResolve=Moq.IResolve;
using MockBehavior=Moq.MockBehavior;
using MockFactory=Moq.MockFactory;

namespace Specish
{
    public class base_automock_test : base_test
    {
        protected T Any<T>()
        {
            return default(T);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MockFactory"/> class.
        /// </summary>
        /// <remarks>Defaults to <see cref="Moq.MockBehavior.Loose"/>.</remarks>
        public base_automock_test()
        {
            this.factory = new MockFactory(MockBehavior.Loose);
            this.Container = new AutoMockContainer(this.factory);
        }
        ...
        {
            this.factory = new MockFactory(MockBehavior.Strict);
            this.Container = new AutoMockContainer(this.factory);
        }
        ...
        public Moq.Mock<T> Mock<T>() where T : class
        {
